...
timelineRouter.get('/', async (req: AuthenticatedRequest, res, next) => {
  try {
...
timelineRouter.get('/stats', async (req: AuthenticatedRequest, res, next) => {
  try {
...
timelineRouter.get('/owned-at', async (req: AuthenticatedRequest, res, next) => {
  try {
